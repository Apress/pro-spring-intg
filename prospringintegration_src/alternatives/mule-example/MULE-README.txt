...
-----------------------------------------------------------------
./src/test/java/com/apress/prospringintegration/mule/muleexample/MuleexampleTestCase.java
...
-----------------------------------------------------------------
./src/test/resources/muleexample-functional-test-config.xml

Defines the Mule configuration for the MuleexampleTestCase.java.
...
artifactId=muleexample
description=Mule Example
muleVersion=3.0.0
packagePath=com/mycompany/mule
forgeProject=n
transports=http,jms,vm
modules=client,cxf,management,scripting,sxc,xml

version=1.0-SNAPSHOT
groupId=com.apress.prospringintegration.mule
basedir=D:\springintegration\test2
--------------------------------------------------------------------